  ...
  return (
    <div className="ping-ui min-h-dvh bg-background text-foreground">
      <div className="form-container">
          ...
          >
                ...
                <div className="flex gap-3">
                  ...
                  >
                    {!photoPreview ? (
                      <>
                        ...
                        <div className="pointer-events-none absolute bottom-2 right-2 flex h-5 w-5 items-center justify-center rounded-full bg-primary text-[10px] text-white shadow-sm">
                  ...
                  <div className="mb-1 flex flex-col justify-end gap-2">
                    <button
                      ...
                      className={`flex w-max items-center justify-center gap-1.5 rounded border border-primary px-4 py-1.5 text-[0.75rem] font-bold text-primary transition hover:bg-primary hover:text-white ob-form-touch ${photoPreview ? "hidden" : "flex"}`}
                      onClick={() => photoInputRef.current?.click()}
                    >
                      <i className="fa-regular fa-image rounded-sm border border-primary px-1 py-0.5 text-[10px]" />
                      사진등록
                    </button>
                    <button
                      type="button"
                        ...
                        <li key={`${h.name}-${idx}`}>
                          ...
                          >
                            <div className="flex items-start gap-3">
                              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-50 text-slate-400 shadow-sm group-hover:bg-primary group-hover:text-white">
              ...
              <div className="mb-4">
                ...
                <div id="timeOfDeathFields" className="flex gap-2">
                  ...
                  <div className="relative min-w-0 flex-[2]">
                    ...
                    <i className="fa-solid fa-chevron-down pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-primary/50" />
                  </div>
                </div>
              </div>
            ...
            <section className="mb-6">
              ...
              <div className="mb-3 flex gap-3">
                <Link
                  href="/mourner-info"
                  className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-primary bg-card py-2.5 text-[0.85rem] font-bold text-primary transition hover:bg-primary hover:text-white ob-form-touch"
                >
              ...
              <div className="mb-5">
                ...
                <div className="flex gap-3">
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute bottom-1 right-1 flex h-5 w-5 items-center justify-center rounded-full bg-primary text-[10px] text-white shadow-sm">
                      <i className="fa-solid fa-plus" />
                    </div>
                  </div>
                  <div className="mb-1 flex flex-col justify-end gap-2">
                    <button
                      ...
                      className="flex w-max items-center justify-center gap-1.5 rounded border border-primary px-4 py-1.5 text-[0.75rem] font-bold text-primary transition hover:bg-primary hover:text-white ob-form-touch"
                      onClick={() =>
                        document.getElementById("companyLogoUpload")?.click()
                      }
                    >
        ...
        <div className="fixed bottom-0 z-30 flex h-[60px] w-full max-w-[var(--ping-service-column,480px)] border-t border-border bg-card shadow-[0_-5px_15px_rgba(0,0,0,0.03)]">
          <button
            type="button"
            id="btnSaveDraft"
            disabled={savingDraft || publishing}
            className="h-full flex-1 border-r border-border bg-card text-[0.95rem] font-[800] text-primary transition hover:bg-muted focus:outline-none disabled:opacity-60 ob-form-touch"
          ...
          <button
            ...
            id="btnSubmit"
            disabled={savingDraft || publishing}
            className="h-full flex-1 bg-primary text-[0.95rem] font-[800] text-white transition hover:opacity-90 focus:outline-none disabled:opacity-60 ob-form-touch"
